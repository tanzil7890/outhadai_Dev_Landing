  ...
  return (
    <main className="min-h-screen gradient-bg relative overflow-hidden">
      ...
      {/* <section className="container mx-auto px-4 py-20 text-center relative z-10">
        <p className="text-xl text-gray-600 mb-12 font-medium">Best-in-class Workflow Automation for businesses of all sizes.</p>
        <div className="flex flex-wrap justify-center items-center gap-12">
          <Image src="/logos/dotwork.svg" alt="Dotwork" width={120} height={40} />
          <Image src="/logos/mercor.svg" alt="Mercor" width={120} height={40} />
          <Image src="/logos/buildspace.svg" alt="Buildspace" width={120} height={40} />
          <Image src="/logos/fluid.svg" alt="Fluid" width={120} height={40} />
          <Image src="/logos/electrada.svg" alt="Electrada" width={120} height={40} />
          <Image src="/logos/thirdweb.svg" alt="Thirdweb" width={120} height={40} />
        </div>
      </section> */}
